# PyCon US 2023 - P79：Tutorials - Lisa Carpenter_ How to create beautiful interactive GUIs and web app - VikingDen7 - BV1114y1o7c5
...
我可以有一千个显示器，上面有我所有的代码和我面前的一切，所以谢谢你容忍我，当我在真人面前冒险回到教室时，不仅仅是事情，一件不好的事情是，当我讲可怕的笑话时，我就知道你不是真的在笑，因为在我的变焦课上。
...
我真的很难过，把地理空间，我实际上没有包括任何地理空间，我对此感到很难过，因为它令人印象深刻，很有趣，嗯，对地理空间感兴趣的人，以后来找我，我会给你大量的资源，我们可以对地图和地理空间感到厌烦。

但是是的，我们今天不太了解地理空间，但剩下的大部分我们都在做，爱它，非常感谢团队，我想最后一个问题，你们都想拍张照片的东西，盐湖城有你推荐的餐厅吗？到目前为止，你吃得好吗？你觉得每个人都应该去那里。

点击那些建议，没有一个是公正的，你认为他们都是坏人，或者你还没去过，好啦，对于那些还在寻找的人来说，请随意抓拍这张照片，你可以，你可以把它拿走，当然啦，会议上的自助餐厅午餐区是真正的答案。

但我看得出来你们都去了，爱它，酷，非常感谢你在那里的提交，它将保持开放，所以如果你想到什么，你可以把它加进去，嗯，这也是问更多离散问题的一种方式，如果你有更概念性的问题。

或者只是你想在最后得到答案的任何东西，您可以随时通过我们的幻灯片提交它们，但是很酷，非常感谢你在那里纵容我，嗯，回到幻灯片上，所以说，让我们来看看，你们的学习目标是在课程结束时。

您应该能够自信地创建和部署单页和多页，多页应用程序实际上是世界上最简单的东西，所以即使提到他们也是一种欺骗，因为它是如此简单，嗯，但我们希望你能用，用于输入和输出的各种小部件。

希望你会对Streamlet感到兴奋，并了解如何提高和继续你的学习，所以我们的议程是这样的，我们将快速介绍流光的概念，它的作用--看看它是如何工作的，然后我们就开始玩它，因为我相信你们都想开始玩。

也不太听讲座，所以我们要直接跳到，建造我们自己的游乐场，看看所有的组件，然后我们有两个现成的例子，它们都是数据科学的例子，在那里你要做一些超参数，在我创造过的最糟糕的模型上调音，嗯，然后一些回归。

回归输入也是，然后我们就结束了，谈谈下一步去哪里，太棒了，贯穿始终的任何问题，只要让我知道太好了，还有几件事我们今天没有讨论，所以我们不会讨论机器学习，我们将使用两个机器学习模型。

但是我们已经为你写好了，他们不是特别棒，所以我不会把它们作为最佳实践，嗯，但是我们今天不会讨论机器学习的概念，我们也不打算进入，如何使用某些可视化库的细节，我相信你知道，现在有另一个教程正在进行。

仅仅靠可视化，这是一个巨大的话题，真的很大，真的很好玩，所以我们将主要关注Streamlet，而不是可视化库，奥基·多基，所以对Streamlet的一点点理论介绍，它是如何工作的，然后我们要跳进操场。

不错嘛，因此，正如您所知，您可以轻松地创建Web应用程序，你不需要任何前端经验，所以我们不需要CSS，我们不需要html，也不需要javascript，所以之前说讨厌JavaScript的人。

你可以很高兴知道你不需要它，Streamlet的一个好处是，如果您愿意，您可以使用它，所以说，如果您想使用CSS，JavaScript和html，你还是可以，你可以把它结合到你的应用程序中。

对于我们中的数据科学家来说，它是在考虑数据的情况下建立的，处理数据有很多漂亮的特性，这么多熊猫都是小溪里的土生土长的，所以你不需要重新发明使用组件的意愿，你已经知道并爱上了。

最喜欢的机器学习库和我们最喜欢的可视化库，就在小溪里工作，它有处理程序，只是使用我们最喜欢的组件，所以我们不需要变通办法，我们不需要那样疯狂的事，我们可以和我们的图书馆合作。

我们喜欢和他们一起工作的方式，Streamlet会为我们做大量的列表，所以马特普特利布·普特利·布克·阿尔特，我们可以像往常一样工作，Strelet会让它发生的，那么Strelet适合哪里呢，真的。

我只是想和你分享小溪，美丽的卡通片，他们有一大堆这样的，我真的很喜欢他们，但这都是关于模型部署阶段的，我们可以使用Streamlet作为Web应用程序，在模型部署阶段真正使我们的模型栩栩如生。

我们的一个例子实际上显示了它也发生在模型构建阶段，嗯，但很多发生在模型开发，这并不是Streamlet的唯一用途，虽然我们有很多方法可以做到这一点，所以模型输入，这是你今天要看到的例子之一。

所以我们有一个机器学习模型，我将向您展示如何使用Streamlet进行输入，让模型做预测，所以它真的让模型栩栩如生，你可以和非数据科学家分享，这样他们就可以根据新的数据做出预测。

我们可以用它来调谐超参数，所以我们的模型，看看不同的参数对它的影响，嗯，交互式数据探索，交互式仪表板，有大量的交互性，我们能做的真的很令人兴奋，Streamlet有一个本地映像类型的界面。

所以你可以从网络摄像机中提取图像，或者只是硬盘上的图片，然后在你的计算机视觉中也使用它，当然，聊天gpt 2可以与任何API一起工作，本质上，它真的只是Python，嗯。

所以如果你想为聊天GPT制作一个界面，或者任何类似小溪的东西都很适合，嗯，您也可以为几乎任何您想要的东西创建接口，或数据的前端，我最近参加了一个游戏节，在那里我正在举办一场锦标赛。

其中一个参与者走过来说，我们能看看数据吗，我们能看看排行榜吗，它就像谷歌床单一样，有大量的机密信息，在一大堆奇怪的事情中，所以不，他们看不到，但十分钟后，我很快就做了一条小溪。

仅链接到谷歌工作表中一个页面的社区云应用程序，整理了资料并提供给他们，我不知道我会怎么做，没有小溪，会很混乱的，流光有很多用途我们可以做很多好事，快到操场了，我保证嗯，所以有三件事你需要知道。

第一个是一切都是函数或方法，是蟒蛇特有的，所以我们要做圣，代表小溪然后点，然后函数或方法，对不起，嗯点对，是我们要学的第一个，它基本上只是输出我们给它的任何东西，如果你给它一个数据帧。

它将输出一个漂亮的数据帧，给它一个形象，它将输出一个美丽的图像，接下来是我们的小部件，嗯，这些是我们要分配给变量的方法，以获得我们想要的，第三件事是组件库，这些是Streamlet的第三方扩展。

我们今天不是真的报道这些，因为有太多，嗯，但它们确实扩展了Streamlet的功能，所以说，它们非常值得一看，好的，Dokey，所以对你们所有人的第一个小测试，我们要做的就是打开我们最喜欢的。

那不是笔记本，我们将尝试我们的第一条小溪，所以它只是进口流作为ST，现在我们要做st dot，然后我们要调用的方法，所以st点头部，当然我们从你好世界开始，嗯，然后一条新线。

在Streamlet中唯一需要的命令，因为一旦你看到它有多美，你只会想玩这个所以点气球，开括号，关闭，一旦你在你的IDE中做到了这一点，你会想把它保存为Streamlet，下划线，应用程序，点。

我们做完了就好了，我们要去蟒蛇提示符，我们要打电话给Streamlet，紧随其后的是运行，后面是你刚才给的文件的名称，希望我们都能看到你好世界和气球，如果你和这些东西作斗争，也不管用，把手举起来。

我们会试着调试，希望我们都能看到一些漂亮的气球，好的队员们，听起来大多数人现在都让它运行了，谢谢你在那里的耐心，当我们进行现场调试时，嗯，所以我想让你做的一件事是回到你的原始文件，把圣点气球换成圣点雪。

斯诺沃雪嗯，只需点击文件上的保存，跳回Streamlet界面，您应该看到它提示您源文件已更改，它想让你点击重播，所以现在您可以开始看到开发周期，您将在本地使用，您不需要一直重新运行该文件。

我们可以做出改变，命中保存，它会重新加载并为我们重新运行，所以试试看，享受雪，你得到了一些雪，很酷吧，你知道的，现在雪地里的气球，你知道的，基本上你需要的一切，准备生产，Okie，Dokie。
...
保存弹出，我有这个总是重播的按钮，如果我想继续点击它，每次我保存我的文件，它将继续进行，并对我所做的做出改变，干净利落的工作方式，你可以看到我们实际上在使用一个多页面的应用程序，你可以把侧边栏去掉。
...
然后我们可以像这样挑深色的，嗯另一个场景，你会看到还有宽模式，这只是意味着它用完了整个容器，而不仅仅是很集中，所以我们有标题标题，分标题，我们现在知道如何在执行代码之间切换，然后看到结果，相当瞬间。
...
好啦，嗯，点击按钮是相当令人满意的，那么我们要不要加一个计数器，看看我们点击按钮的次数，有多少次我们被诱惑去看那些美丽的气球或雪地，所以让我们试试这个权利，是啊，是啊，我们还算可以，别管酷了。
...
所以我们放了一些占位符，我们要快速完成代码，第一个是单选按钮，当然你只能选一个，这是如此美好和简单，我们将从变量开始，这将是输入的位置，这样我们就可以用它了，我们要用选定的等式，然后就只有圣电台了，嗯。
...
很好吃很好吃，很好的大拇指在那里和一些很好的咖啡，希望我们感觉精力充沛，准备好了，所以你看了很多输入，现在我们将用这些输入做一个工作示例，所以这是我们的最终目标，我们正试图制造一个超参数，金枪鱼。
...
然后单击此处运行模型，但我们对你和我的挑战是，真的帮你，这是使用我们为您制作的教程版本，希望很清楚你需要做什么，我们在这儿编了一本字典，超参数字典，您的任务是创建这些输入。
...
我知道你玩输入很开心，但我们要花点时间，看看一些输出，所以你现在会看到在随机森林的教程版本中，它只是把那些原始输出写到最后，我们还没有看到的，如何做一些很酷的可视化，所以如果我们能回到操场文件。
...
所以操场在高处，是呀，好了，我们要看看这个操场，正如你此刻所看到的，只是占位符，我们将看看如何实际填充它，所以在我们有那些公制标签之前，我们在超参数金枪鱼上看到，所以我们要看看我们如何才能真正继续下去。
...
如果我们快点抓住这个，网络浏览器，然后，如果你不确定你的城市是否会在那里，您可以在这里快速测试，我们可以看到我们得到的输出伦敦目前是12度，嗯，所以你可以随时去你的网络浏览器，用城市名称替换城市URL。
...
然后海运，我不知道为什么C生重复了两次，那真的很奇怪，Seaborn和Matplotlib，嗯，因为他们都属于同一个家庭，其实只是，我们把它叫做无花果，所以我们只是在这里做无花果，其实是一样的。
...
它会继续在侧面呈现输出，它也有一些很酷的，呃工作，所以如果你有像网页刮擦API访问这样的东西，您可以出售它来自动在计划中运行脚本，它也有呃，您自己的库，如果您创建了库，你可以把它们嵌入，它也有数据存储。
